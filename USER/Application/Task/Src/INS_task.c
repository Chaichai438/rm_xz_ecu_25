...
//     x  y  z                          ���Ӻͳ� ͬ����1 ������-1   ����R�¶�Ӧroll��x��  ��Rƽ�洹ֱ����pitch(y)  ��ֱ���ӵ���yaw(z)
//x                                                                       ��������ת
//y   
//z
...
static fp32 INS_accel[3] = {0.0f, 0.0f, 0.0f};		//���ٶ�
static fp32 INS_mag[3] = {0.0f, 0.0f, 0.0f};		//�ش�
...
/**
  ...
  * @retval         
  */
void angle_change(fp32 *INS_euler_angle,fp32 *INS_gyro_fp32)
{
	int i;
	for(i=0;i<3;i++){
		GYRO_euler_angle_fp32[i] = INS_euler_angle[i];
//		euler_angle_fp32[i] = INS_euler_angle[0] ; 
		GYRO_gyro_fp32[i]=INS_gyro_fp32[i];
	}
}
...
//            ist8310_read_mag(ist8310_real_data.mag);
		...
		angle_change(INS_angle,INS_gyro);
		groy_get();
    }
}
