...
//
//void USART_Vofa_Justfloat_Transmit(void){
//
//    __attribute__((section (".AXI_SRAM")))  static uint8_t Rx_Buf[16];
//
//    float SendValue1 = 1.f;
//    float SendValue2 = 1.f;
//    float SendValue3 = 1.f;
//
//
//
//    uint8_t *SendValue1_Pointer,*SendValue2_Pointer,*SendValue3_Pointer;
...
//
//    char buffer[128] = {0};
//    int len = sprintf(buffer,"%f,%f,%f\n",SendValue1,SendValue2,SendValue3);
//
////
//    HAL_UART_Transmit(&huart1,(uint8_t *)buffer, strlen());
//
////        HAL_Delay(20);
//
//
