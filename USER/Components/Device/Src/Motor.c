...
void DJI_M3508_Send_Single_Current(FDCAN_TxFrame_TypeDef *FDCAN_TxFrame,DJI_Motor_Info_Typedef *DJI_Motor,int16_t Current)
{
...
//void DJI_Motor_CAN_TxMessage(FDCAN_TxFrame_TypeDef *FDCAN_TxFrame,DJI_Motor_Info_Typedef *DJI_Motor,float Postion, float Velocity, float KP, float KD, float Torque){
//
//
